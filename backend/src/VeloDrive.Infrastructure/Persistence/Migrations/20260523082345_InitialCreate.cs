        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemAddOns_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "text", nullable: true),
                    AttributeSchema = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepositRequired = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookingAddOns_BookingItems_BookingItemId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingAddOns_ItemAddOns_AddOnId",
                        column: x => x.AddOnId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingAddOns_BookingItemId",
                table: "BookingAddOns",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemAddOns_TenantId",
                table: "ItemAddOns",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemCategories_TenantId_Slug",
